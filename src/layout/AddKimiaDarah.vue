        ...
        <div >
            ...
            <form @submit.prevent="onFormSubmit">
                <div>
                    ...
                    <div class="form-group">
                        <label>Metode</label>
                        <input type="text" class="form-control" placeholder="Metode" v-model="kimiaDarah.metode" required>
                    </div>
                    <div class="form-group">
                        <label>Harga</label>
                        <input type="number" class="form-control" placeholder="Harga" v-model="kimiaDarah.harga" required>
                    </div>
                </div>
                <div class="form-group">
